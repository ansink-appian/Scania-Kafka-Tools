...
public class AppianKafkaConsumerThread_V1 extends Thread {

  private static final Logger LOG = Logger.getLogger(AppianKafkaConsumerThread_V1.class);
  ...
  public AppianKafkaConsumerThread_V1(Context ctx, Properties props, String dsName, String transactionTableName, String topic,
    Integer jobTypeId,
