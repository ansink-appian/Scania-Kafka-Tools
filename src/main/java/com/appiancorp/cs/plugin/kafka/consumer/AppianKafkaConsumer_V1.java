...
public class AppianKafkaConsumer_V1 {
  ...
  public AppianKafkaConsumer_V1(Properties props, String dsName, String transactionTableName, String topic, Integer jobTypeId,
  ...
  public AppianKafkaConsumer_V1(Properties props, Context context, String dsName, String transactionTableName, String topic,
    Integer jobTypeId,
    Integer pollingInterval, Integer sleepingInterval, String messageFilter) {
    _ctx = context;
    _props = props;
