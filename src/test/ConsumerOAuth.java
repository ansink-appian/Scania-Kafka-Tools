...
public class ConsumerOAuth {
    ...
    private static Properties configureConsumer(){
        ...
        properties.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, getEnvironmentVariables("BOOTSTRAP_SERVERS_CONFIG", "https://oauthaws.iris-streaming.devtest.aws.scania.com:9093"));
